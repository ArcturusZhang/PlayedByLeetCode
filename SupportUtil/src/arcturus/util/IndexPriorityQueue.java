...
/**
 *  The {@code IndexPriorityQueue} class represents an indexed priority queue of generic keys.
...
public class IndexPriorityQueue<Key extends Comparable<Key>> implements Iterable<Integer> {
    ...
    /**
     * Unit tests the {@code IndexPriorityQueue} data type.
     *
    ...
    public static void main(String[] args) {
        ...
        IndexPriorityQueue<String> pq = new IndexPriorityQueue<String>(strings.length);
